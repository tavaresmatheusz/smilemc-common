package br.com.smilemc.commons.common.util.mojang;
...
public class UUIDFetcher {
	...
	private UUID request(int idx, String api, String name) {
		try {
			...
			JsonElement element = Common.getJsonParser()
	...
	public boolean hasPremiumMC(String name) {
	...
	public UUID getUUID(String name) {
		...
		return Common.getBackendManager().getSqlManager().getUuidByName(name);
	}
